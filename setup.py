...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-product_dynamic_configurator_sale_opportunity',
    download_url='https://github.com:nantic/trytond-product_dynamic_configurator_sale_opportunity.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-product_dynamic_configurator_sale_opportunity.git'
    },
    classifiers=[
